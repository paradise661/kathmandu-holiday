<?php $get_trips = kk_get_custom_post_type(-1, 'pit_trips', 'DESC', 'date', '', '', 'trekking-in-nepal', 'pit_category');
if ($get_trips) { ?>
            ...
            <div class="section-heading text-center">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <p>We are the leading Trekking Company in Nepal offering an extensive spectrum of travel services.</p>
                    </div>
                </div>
            </div>
