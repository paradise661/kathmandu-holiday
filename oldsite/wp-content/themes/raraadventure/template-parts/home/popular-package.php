<?php $get_trips = kk_get_custom_post_type(-1, 'pit_trips', 'DESC', 'date', '', '', 'leisure-family-tour', 'pit_category');
if ($get_trips) { ?>
    <section class="package-section">
		<div class="available-24 text-white">
			<bold><i class="fas fa-clock"></i> Available 24*7</bold>
			<a href="#" class="nav-link"><i class="fas fa-phone-alt"></i> <?= get_field('phone','option'); ?></a>
		</div>
        <div class="container">
            <div class="section-heading text-center">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <h2>Leisure & Family Tour</h2>
                        <p>Kathmandu Holiday Travel and Tours provide exciting Nepal tour package with an affordable rate. We provide excellent service in regionable price.</p>
                    </div>
                </div>
            </div>
