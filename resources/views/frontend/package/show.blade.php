                                                                        ...
                                                                        <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                                                                            <div class="content-box">
                                                                                <div class="title-box mb_35">
                                                                                    ...
                                                                                    <a href="{{ route('package.pdf', $content->id) }}" class="title-head btn print-btn" target="_blank"><i class="fa fa-file-pdf"></i></a>
                                                                                    </div>
                                                                                    <ul class="info-list clearfix">
                                                                                        ...
                                                                                        @if ($content->activity->priceper)
                                                                                            <li>
                                                                                                ...
                                                                                                <span>Per
                                                                                                    person</span>
                                                                                                <h4><strong style="font-weight: 600; font-style: italic;">{{ $content->activity->priceper ?? '' }}</strong>&nbsp;/&nbsp;{{ $content->activity->priceperusd ?? '' }}</h4>
                                                                                            </li>
                                                                                        @endif
                                                                                        ...
                                                                                        <div class="tab-btn-box p_relative pb_20">
                                                                                            <ul class="tab-btns tab-buttons clearfix">
                                                                                                ...
                                                                                                @if ($content->->isNotEmpty())
                                                                                                    <li class="tab-btn" data-tab="#tab-6">Departure Date</li>
                                                                                                @endif
                                                                                            </ul>
                                                                                        </div>
