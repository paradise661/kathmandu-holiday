            ...
            <section class="contact-info-section pt_50 pb_50 centred">
                <div class="auto-container">
                    @if ($branches->isNotEmpty())
                        ...
                        $phones = explode(',', $headOffice->phone ?? '');
                        $emails = explode(',', $headOffice->email ?? '');
                                                    @endphp
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 info-column centred">
                                                                <div class="info-block-one info-block-new">
                                                                    <div class="inner-box-two">
                                                                        ...
                                                                        @php $e = trim($email); @endphp
                                                                        <p><a href="mailto:{{ $e }}">{{ $e }}</a>
                                                                        </p>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-sm-12 info-column ">
                                                                    <div class="info-block-one d-flex h-100 ">
                                                                        <div class="inner-box flex-grow-1">
                                                                            {{-- <div class="icon-box2 contact-icon-container"><i class="icon-24 contact-icon"></i></div> --}}
                                                                            <h2 style="color: #005191; font-size: 1.6rem; text-align: left;">{{ $branch->name }}@if ($loop->first) (Head Office) @endif</h2>
                                                                            <div class="d-flex align-items-center gap-2 mt-3">
                                                                                <div class="icon-box2"><i class="icon-24"></i></div>
                                                                                <p><a href="/" style="text-align: left;">{{ $branch->location }}</a></p>
                                                                            </div>
                                                                            <div class="d-flex align-items-center gap-2 mt-3">
