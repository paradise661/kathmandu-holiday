                        ...
                        <div class="row clearfix">
                            <div class="col-12 mt-5">
                                ...
                                <div class="table-responsive shadow rounded-3">
                                    <table class="table align-middle table-hover mb-0" style="text-align: center;">
                                        ...
                                        <tbody style="font-size: 14px;">
                                            @foreach ($content->items as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-light text-dark px-3 py-2 rounded-pill table-font">
                                                            {{ $item->date }}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-success px-3 py-2 rounded-pill table-font table-badge-new">Yes</span>
                                                    </td>
                                                    <td>
                            ...
                            @if ($content->description || $content->image || $content->route)
                                <div class="col-md-12 col-sm-12 content-side mt-4">
