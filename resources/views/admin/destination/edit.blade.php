...
@section('title', 'Edit ' . $destination->name . ' - Wander Travel')
        ...
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end">
                    <a class="btn btn-sm btn-primary" href="{{ route('destinations.index') }}"><i
                            class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
            <div class="card-body p-0">
                <form class="row" method="POST" action="{{ route('destinations.update', $destination->id) }}"
                        ...
                        <div class="card card-body main-description shadow br-8 p-4">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" id=""
                                            type="text" name="name" value="{{ old('name', $destination->name) }}"
                                            placeholder="">
                                        @error('name')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('slug') is-invalid @enderror" id=""
                                            type="text" name="slug" value="{{ old('slug', $destination->slug) }}"
                                            placeholder="">
                                        @error('slug')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control ckeditor br-8 @error('description') is-invalid @enderror" id="description"
                                    name="description" rows="10" placeholder="Enter Description">{{ old('description', $destination->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control br-8 @error('short_description') is-invalid @enderror" id="short_description"
                                    name="short_description" rows="4" placeholder="Enter short_Description">{{ old('short_description', $destination->short_description) }}</textarea>
                            ...
                            <fieldset class="border p-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control br-8" type="text" name="seo_title"
                                        value="{{ old('seo_title', $destination->seo_title) }}"
                                        placeholder="Enter Seo Title">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="seo_description">Seo Description</label>
                                    <textarea class="form-control br-8" name="seo_description" rows="4" placeholder="Enter Seo Description">{{ old('seo_description', $destination->seo_description) }}</textarea>
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control br-8" name="seo_schema" rows="10" placeholder="Enter Seo Schema">{{ old('seo_schema', $destination->seo_schema) }}</textarea>
                                </div>
                            </fieldset>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card-body card shadow br-8">
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0" @if ($destination->status == 0) selected @endif>
                                        Draft</option>
                                    <option class="p-3"@if ($destination->status == 1) selected @endif value="1">
                                        Publish</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3 mt-2">
                                ...
                                <div class="custom-file">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($destination->banner)
                                                    @php
                                                        $banner = get_media($destination->banner ?? '');
                                                    @endphp
                                    ...
                                    <input class="" id="banner_id" type="hidden" name="banner"
                                        value="{{ old('banner', $destination->banner) }}">
                                    @error('banner')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($destination->image)
                                                    @php
                                                        $feature = get_media($destination->image ?? '');
                                                    @endphp
                                                    @if ($feature)
                            ...
                            <div class="card-footers d-flex justify-content-between">
                                <a class="btn btn-sm btn-success"
                                    href="{{ route('destinationsingle', $destination->fullslug) }}" target="_blank"><i
                        ...
                        @include('admin.destination.includes.parent')
                    </div>
                </form>
            </div>
        </div>
