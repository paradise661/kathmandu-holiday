...
@section('title', 'Edit ' . $whyu->name . ' - Kathmandu Holiday')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Icon - {{ $whyu->name }}</h5>
                <small class="text-muted float-end">
                    <a class="btn btn-sm btn-primary" href="{{ route('whyus.index') }}"><i class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
                        ...
                        <div class="card-body card shadow br-8">
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0" @if ($whyu->status == 0) selected @endif>
                                        Draft</option>
                                    <option class="p-3"@if ($whyu->status == 1) selected @endif value="1">
                                        Publish</option>
                                </select>
                            </div>
