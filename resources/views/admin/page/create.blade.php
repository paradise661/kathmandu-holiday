...
@section('title', 'Create New Page - Kathmandu Holiday')
                        ...
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-3" id="template" name="template">
                                    ...
                                    <option class="p-3" value="14">All Packages</option>
                                    <option class="p-3" value="15">Packages Category</option>
                                    ...
                                    <option class="p-3" value="13">Gallery</option>
