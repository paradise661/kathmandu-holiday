                            ...
                            <ul class="nav nav-tabs px-4" id="myTab" role="tablist">
                                <li class="nav-item" role="activity">
                                    <button class="nav-link active" id="activity-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="activity" aria-selected="true">ACTIVITY</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="overview-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-overview" type="button" role="tab"
                                        aria-controls="route" aria-selected="false">USEFUL INFO</button>
                                </li>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade" id="nav-overview" role="tabpanel"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control ckeditor1" id="" name="overview" cols="30" rows="10"> {{ old('overview', $package->overview) }}</textarea>
                                        @error('overview')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                                                        ...
                                                        <tr>
                                                            <td style="width: 95%">
                                                                ...
                                                                <textarea class="form-control faqeditor{{ $key }}" id=""
                                                                    name="addmorefaq[{{ $key }}][description]" cols="20" rows="3">{{ $faq->description }}</textarea>
                                                            </td>
                                                            <td>
                                                                @if ($key == 0)
                                                                    <button class="btn btn-link" id="add-btn-faq"
                                                                        type="button" name="addfaq"><span
                                                                            class="badge badge-center rounded-pill bg-primary"><i
                                                                                class="fa-solid fa-plus"></i></span></button>
                                                                @else
                                                                    <button class="btn btn-link remove-tr-faq"
                                                                        type="button"><span
                                                                            class="badge badge-center rounded-pill bg-danger"><i
                                                                                class="fa fa-times"></i></span></button>
                                                                @endif
                                ...
                                <div class="tab-pane fade" id="nav-inclusion-exclusion" role="tabpanel"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control ckeditor2" id="" name="inclusions" cols="30" rows="10">{{ old('inclusions', $package->inclusions) }}</textarea>
                                        @error('inclusions')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <textarea class="form-control ckeditor3" id="" name="exclusions" cols="30" rows="10">{{ old('exclusions', $package->exclusions) }}</textarea>
                                        @error('exclusions')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="tab-pane fade" id="nav-seo" role="tabpanel" aria-labelledby="nav-seo-tab">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('seo_description') is-invalid @enderror" id="" name="seo_description"
                                            cols="30" rows="10">{{ old('seo_description', $package->seo_description) }}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control @error('type') is-invalid @enderror"
                                                type="text" name="type"
                                                value="{{ old('type', $packageActivities->type ?? '') }}">
                                            @error('type')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control br-8" name="durationinfo">{{ $packageActivities->durationinfo ?? '' }}</textarea>
                                            @error('durationinfo')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control br-8" name="typeinfo">{{ $packageActivities->typeinfo ?? '' }}</textarea>
                                            @error('typeinfo')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control @error('size') is-invalid @enderror"
                                                type="text" name="size"
                                                value="{{ old('size', $packageActivities->size ?? '') }}">
                                            @error('size')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control br-8" name="sizeinfo">{{ $packageActivities->sizeinfo ?? '' }}</textarea>
                                            @error('sizeinfo')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label" for="basic-default-fullname">Transportation
                                                Info</label>
                                            <textarea class="form-control br-8" name="transportationinfo">{{ $packageActivities->transportationinfo ?? '' }}</textarea>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control @error('season') is-invalid @enderror"
                                                ...
                                                value="{{ old('season', $packageActivities->season ?? '') }}">
                                            @error('season')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control br-8" name="activityinfo">{{ $packageActivities->activityinfo ?? '' }}</textarea>
                                            @error('activityinfo')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label" for="basic-default-fullname">Best Season
                                                Info</label>
                                            <textarea class="form-control br-8" name="seasoninfo">{{ $packageActivities->seasoninfo ?? '' }}</textarea>
                                            @error('seasoninfo')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control @error('meal') is-invalid @enderror"
                                                type="text" name="meal"
                                                value="{{ old('meal', $packageActivities->meal ?? '') }}">
                                            @error('meal')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label" for="basic-default-fullname">Accomodation
                                                Info</label>
                                            <textarea class="form-control br-8" name="accomodinfo">{{ $packageActivities->accomodinfo ?? '' }}</textarea>
                                            @error('accomodinfo')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control br-8" name="mealinfo">{{ $packageActivities->mealinfo ?? '' }}</textarea>
                                            @error('mealinfo')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0"
                                        @if ($package->status == 0) selected @endif>Draft</option>
                                    <option class="p-3"@if ($package->status == 1) selected @endif
