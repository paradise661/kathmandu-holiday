(function ($) {
    ...
    $("#pck_submit").click(function (e) {
        e.preventDefault();
        var PckData = new FormData($("#packagebooking")[0]);
        $("#pck-name-error").html("");
        $("#pck-email-error").html("");
        $("#pck-phone-error").html("");
        $("#pck-numpax-error").html("");
        $("#pck-date-error").html("");
        $("#pck-address-error").html("");
        $("#pck-message-error").html("");
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.errors) {
                    $("#pck-loader").hide();
                    if (data.errors.name) {
                        $("#pck-name-error").html("*" + data.errors.name[0]);
                    }
                    if (data.errors.email) {
                        $("#pck-email-error").html("*" + data.errors.email[0]);
                    }
                    if (data.errors.phone) {
                        $("#pck-phone-error").html("*" + data.errors.phone[0]);
                    }
                    ...
                    if (data.errors.numpax) {
                        $("#pck-numpax-error").html(
                            "*" + data.errors.numpax[0]
                        );
                    }
                    if (data.errors.date) {
                        $("#pck-date-error").html("*" + data.errors.date[0]);
                    }
                    if (data.errors.message) {
                        $("#pck-message-error").html(
